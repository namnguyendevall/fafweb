    ...
    const navLinks = [
        {
            ...
            label: t('task_owner.sidebar_overview'),
            icon: (
        ...
        {
            to: "/task-owner/jobs",
            label: t('task_owner.sidebar_jobs'),
            icon: (
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        },
        {
            ...
            label: t('task_owner.sidebar_contracts'),
            icon: (
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        },
        {
            ...
            label: t('task_owner.sidebar_talent'),
            icon: (
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        },
        {
            ...
            label: t('task_owner.sidebar_profile'),
            icon: (
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <aside className="w-[280px] hidden lg:flex flex-col gap-6 p-6 sticky top-14 h-[calc(100vh-3.5rem)] overflow-y-auto bg-transparent border-r border-cyan-500/10">
            ...
            <div className="relative group rounded-2xl border p-5 overflow-hidden transition-all hover:border-cyan-500/40 shadow-[0_8px_32px_rgba(0,0,0,0.5)]" 
                ...
                <div className="relative z-10 flex flex-col items-center">
                    ...
                    <div className="text-center space-y-1">
                        <p className="text-[10px] font-mono tracking-[0.2em] text-cyan-400 uppercase font-black">{t('task_owner.sidebar_employer')}</p>
                        ...
                        <div className="flex items-center justify-center gap-1.5 pt-1">
                            ...
                            <span className="text-[9px] font-mono text-slate-400 tracking-widest uppercase">{t('task_owner.sidebar_verified')}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-6 pt-4 border-t border-white/5 flex items-center justify-between">
                    <div className="text-left">
                        <p className="text-[9px] font-mono text-slate-500 uppercase tracking-widest">{t('task_owner.sidebar_reputation')}</p>
                        <p className="text-xs font-black text-white font-mono">98.4%</p>
                    </div>
                    <div className="text-right">
                        <p className="text-[10px] font-mono text-slate-500 uppercase tracking-widest">{t('task_owner.sidebar_tier')}</p>
            ...
            <div className="flex-1 flex flex-col gap-2">
                <p className="px-4 text-[9px] font-mono tracking-[0.3em] text-slate-500 uppercase font-black mb-1">
                    {t('task_owner.sidebar_navigation')}
                </p>
