               ...
               {(resourceUrls || []).length > 0 && (
                   <div className="flex flex-col gap-2 mt-4">
                       {(resourceUrls || []).map((res, idx) => {
                           ...
                           return (
                             <div key={idx} className="flex items-center justify-between group bg-white/5 border border-white/10 rounded-xl p-3 hover:border-fuchsia-500/30 transition-all hover:bg-white/[0.08]">
                               <div className="flex items-center gap-3 overflow-hidden">
                                 ...
                                 <div className="flex flex-col overflow-hidden">
                                   <button 
                                     ...
                                     className="text-xs font-mono text-slate-300 hover:text-fuchsia-400 truncate text-left transition-colors"
                                   >
                                     {name}
                                   </button>
